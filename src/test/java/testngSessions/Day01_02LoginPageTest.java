...
public class Day01_02LoginPageTest {
	...
	public void loginNegativeTest() {
		driver.findElement(By.id("input-email")).sendKeys("archana@gmail.com");
		...
		// Writing if-else for validation does not work, here, test case will get passed, 
		// but it is not validation.
		// For that we have to use assertion

//		if(errorMesg.contains("Warning: No match for E-Mail Address and/or Password123")) {
